...
// 14种人格原型社交能量温度表 (0-100分)
// 🔥超高能量(85+): 外向型社交达人
// 🌡️高能量(60-84): 活跃型社交者
// 🌤️中等能量(40-59): 平衡型参与者
// ❄️低能量(<40): 内向型深度思考者
const ARCHETYPE_ENERGY: Record<string, number> = {
  "社交蝴蝶": 95,      // 🔥 超高能量，社交场合的焦点
  "活动策划家": 90,    // 🔥 超高能量，组织力强
  "幽默调和者": 88,    // 🔥 超高能量，气氛担当
  "群聊发动机": 85,    // 🔥 超高能量，话题引导者
  "好奇探索者": 75,    // 🌡️ 高能量，主动探索
  "故事大王": 70,      // 🌡️ 高能量，善于表达
  "氛围感知者": 65,    // 🌡️ 高能量，情绪敏感
  "温暖聆听者": 55,    // 🌤️ 中等能量，温和友善
  "深度交流家": 50,    // 🌤️ 中等能量，深度对话
  "灵魂摆渡人": 45,    // 🌤️ 中等能量，精神导师
  "价值观守护者": 40,  // 🌤️ 中等能量，原则性强
  "理性分析师": 35,    // ❄️ 低能量，理性思考
  "神秘观察者": 30,    // ❄️ 低能量，安静观察
  "独立思考者": 25     // ❄️ 低能量，独立沉思
};
